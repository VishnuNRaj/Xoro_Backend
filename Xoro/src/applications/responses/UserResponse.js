...
const editChannelRes = (data) => __awaiter(void 0, void 0, void 0, function* () {
    return {
        message: data.message,
        status: data.status,
...
exports.editChannelRes = editChannelRes;

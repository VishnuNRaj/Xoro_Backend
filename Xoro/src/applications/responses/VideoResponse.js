...
const getVideoRes = (data) => __awaiter(void 0, void 0, void 0, function* () {
    return data;
});
exports.getVideoRes = getVideoRes;
const getVideosRes = (data) => __awaiter(void 0, void 0, void 0, function* () {
    return data;
});

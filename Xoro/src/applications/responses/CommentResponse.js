...
exports.addCommentRes = addCommentRes;
const addCommentReplyRes = (data) => __awaiter(void 0, void 0, void 0, function* () {
    return data;
});
exports.addCommentReplyRes = addCommentReplyRes;
const getCommentsRes = (data) => __awaiter(void 0, void 0, void 0, function* () {
    return data;
});

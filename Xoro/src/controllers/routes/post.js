...
postRouter.patch('/reactions/like/:PostId', UserController_1.VerifyUserAuth, Middleware.LikePost);
postRouter.patch('/reactions/dislike/:PostId', UserController_1.VerifyUserAuth, Middleware.DislikePost);
postRouter.patch('/reactions/remove/:PostId', UserController_1.VerifyUserAuth, Middleware.RemoveReactions);
